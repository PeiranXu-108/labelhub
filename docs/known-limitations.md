...
- Supervisor follow-up Tasks 13-19 document expanded requirements that are not implemented yet: drag-and-drop template building, rich media fields, dynamic form rules/layouts, field-level LLM assist, labeler navigation, multistage review, and production runtime verification.
...
- Uploaded file/image materials are not production-ready until Task 14 is implemented and a retention/storage policy is decided.
